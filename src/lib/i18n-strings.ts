...
export const STRINGS = {
  ...
  hi: {
    ...
    "nav.you": "आप",
    "nav.steady": "स्टेडी",
    "nav.today.desc": "आप कैसे आ रहे हैं",
    ...
    "nav.you.desc": "आपका हफ़्ता और नियंत्रण",
    "steady.label": "स्टेडी",
...
const HI_TEXT: Record<string, string> = {
  /* home — greetings & sky */
  "Welcome": "स्वागत है",
  "Still up": "अब तक जाग रहे हैं",
  "Good morning": "सुप्रभात",
  "Good afternoon": "नमस्ते",
  "Good evening": "शुभ संध्या",
  "Winding down": "दिन समेट रहे हैं",
  "today's inner sky": "आज का भीतरी आकाश",
  "How are you arriving today?": "आज आप किस हाल में आ रहे हैं?",
  "how are you arriving today?": "आज आप किस हाल में आ रहे हैं?",
  ...
  "The light is lowering. Whatever the day held, it can be set down here.":
    "रोशनी धीमी हो रही है। दिन में जो भी रहा, उसे यहाँ रख सकते हैं।",
  ...
  "a tender day. be gentle with the hours.": "एक नाज़ुक दिन। घंटों से नरमी बरतें।",
  ...
  "Dear —, here is what I never said…": "प्रिय —, यह वह है जो मैंने कभी नहीं कहा…",
  "Fact vs feeling": "हक़ीक़त बनाम एहसास",
  "untangle what happened from what it felt like": "जो हुआ, उसे उससे अलग करें जो महसूस हुआ",
  ...
  "A letter to my future self": "आने वाले मुझ को एक ख़त",
  "for the you who will read this later": "उस आप के लिए, जो इसे बाद में पढ़ेंगे",
